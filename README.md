...
5 July 2025, MGateway Ltd [http://www.mgateway.com](http://www.mgateway.com)

* Current Release: Version: 3.1; Revision 50.
...
### v3.1.48 (15 June 2025)
   * Correct a fault in sizing of the response payload (related to 2.8.45).

### v3.1.50 (5 July 2025)
   * Report an error message in the event log if a response generated by YottaDB is too large to fit into the available buffer space.  The message will recommend configuring **mg\_web** to allocate more memory for servicing requests. This only applies to API-based connectivity to YottaDB.
       * Example message: "Insufficient buffer space (response size: 12811; buffer space: 10496). Increase the 'request_buffer_size' in the configuration."
